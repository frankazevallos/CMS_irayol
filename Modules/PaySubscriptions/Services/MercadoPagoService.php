...
namespace Modules\PaySubscriptions\Services;

use Illuminate\Http\Request;
use Modules\PaySubscriptions\Traits\ConsumesExternalServices;
use Modules\PaySubscriptions\Services\CurrencyConversionService;
